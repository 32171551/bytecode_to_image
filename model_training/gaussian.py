...
import os
data_path = "/home/aiia/daeun/data/p"
...
class DiffusionModel(keras.Model):
    ...
    def plot_images(
        self, epoch=None, logs=None, num_rows=1, num_cols=2, figsize=(12, 5)
    ):
...
checkpoint_dir = "/home/aiia/daeun/data/save/"
...
filepath = "/home/aiia/daeun/data/save/saved-model-diffusion-{epoch:02d}-{loss:.2f}"
checkpoint = tf.keras.callbacks.ModelCheckpoint(filepath, monitor='loss', verbose=1, save_weights_only=True, save_best_only=True, mode='min')
...
model.fit(
    ...
    epochs=num_epochs,
    batch_size=batch_size,
    callbacks=[checkpoint] #이미지 띄우는 부분
)
