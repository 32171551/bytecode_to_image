...
import os
data_path = "/home/aiia/daeun/data/train/1"
data_dir = pathlib.Path(data_path)
# 현재 디렉토리내에 각각의 파일을 출력

print(os.path.exists(data_dir)) #데이터 경로 확인
...
class DiffusionModel(keras.Model):
    ...
    def plot_images(
        ...
        img_list = os.listdir('generated_img_3')
        if len(img_list) == 0:
            c = 0
        else:
            c = len(img_list)
        img_path = os.path.join('generated_img_3', str(c) + '.jpg')
